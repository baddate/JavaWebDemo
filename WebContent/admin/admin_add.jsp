            ...
            <form action="admin_add.test" method="post" class="main_form">
                    ...
                    <div class="input_info_high">
                        <div class="input_info_scroll">
                            <ul>
                                <li><input type="checkbox" name="superadmin" />超级管理员</li>
                                <li><input type="checkbox" name="billadmin" />账务账号管理员</li>
                                <li><input type="checkbox" name="feeadmin" />业务账号管理员</li>
                                <li><input type="checkbox" name="zadmin" />资费管理</li>
                            </ul>
                        </div>
                        <span class="required">*</span>
