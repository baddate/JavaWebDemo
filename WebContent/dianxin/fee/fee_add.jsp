...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="fee_add.do" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" name="shichang" value="" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="jifei" value="" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="danfei" value="" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea name="shuoming" class="width300 height70"></textarea>
                    <div class="validate_msg_short error_msg">100长度的字母、数字、汉字和下划线的组合</div>
                </div>                    
                <div class="button_info clearfix">
                    <input type="submit" value="保存" class="btn_save"  onclick="showResult();" />
                    <input type="button" value="取消" class="btn_save" onclick="location.href='http://localhost:8080/NewWeb/dianxin/fee/fee_list.html';"/>
                </div>
            </form>  
        </div>
        <!--主要区域结束-->
