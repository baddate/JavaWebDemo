...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="fee_modify.do" method="post" class="main_form">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"><input type="text" class="readonly" name="id" readonly value="${result.zifeiid}" /></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" name="name" class="width300" value="${result.zifeimingchen}"/>
                ...
                <div class="input_info">
                    <input type="text" name="shichang" value="${result.jibenshichang}" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="jifei" value="${result.jibenfeiyong}" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="danfei" value="${result.danweifeiyong}" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea name="shuoming" class="width300 height70">${result.zifeishuoming}
                    </textarea>
