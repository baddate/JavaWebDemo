    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="user_info.test" method="post" class="main_form">
                ...
                <div class="input_info"><input type="text" readonly="readonly" class="readonly" value="${user.account}" /></div>
                ...
                <div class="input_info">
                    <input type="text" class="width200" value="${user.phone}" />
                    <div class="validate_msg_medium">电话号码格式：手机或固话</div>
                </div>
                <div class="text_info clearfix"><span>Email：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" value="${user.email}" />
